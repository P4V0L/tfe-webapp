...
export function OrderSummary({ orderInfo, cartItems, orderId }: OrderSummaryProps) {
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 md:px-14">
            <Card className="bg-white shadow-sm w-full">
                ...
                <CardContent className="space-y-4">
                    ...
                    {discount > 0 && (
                        <div className="flex flex-col sm:flex-row justify-between text-sm text-accent">
                            <span>Descuento</span>
                            <span>-{discount.toFixed(2)}€</span>
                        </div>
                    )}
                    <div className="border-t pt-4 flex flex-col sm:flex-row justify-between font-medium">
                        <span>Total</span>
            ...
            <div className="flex justify-center mt-8">
                <Link href="/">
                    <Button className="bg-accent hover:bg-accent/90 text-white w-full sm:w-auto px-8">
                        Volver a la tienda
                    </Button>
                </Link>
            </div>
